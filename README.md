...
## Functionalities for future extensions
While this benchmarking study and pipeline focuses on top-down viewpoints and grasping single object, we also provide the following functionality to expand the work for multi-object cases and different camera viewpoints - 
...
```
 ...
 - [GPD](https://github.com/atenpas/gpd), a popular **6-DOF grasping algorithm** is implemented for reference. The following image shows grasps generated by GPD for a tennis ball on the table.
