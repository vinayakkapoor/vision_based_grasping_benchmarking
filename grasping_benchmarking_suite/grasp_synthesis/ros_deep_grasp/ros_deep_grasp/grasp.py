...
import _init_paths
from ros_deep_grasp_module.lib.model.config import cfg
from ros_deep_grasp_module.lib.model.test import im_detect
from ros_deep_grasp_module.lib.model.nms_wrapper import nms

from ros_deep_grasp_module.lib.utils.timer import Timer
...
from ros_deep_grasp_module.lib.nets.vgg16 import vgg16
from ros_deep_grasp_module.lib.nets.resnet_v1 import resnetv1
import scipy
...
def run_detector(image=None):
    ...
    tfmodel = os.path.join('ros_deep_grasp_module/output', demonet, DATASETS[dataset][0], 'default',
                              NETS[demonet][0])
